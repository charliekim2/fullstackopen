...
describe("total likes", () => {
  ...
  test("when list has many blogs, equals sum of them", () => {
...
describe("most blogs", () => {
  ...
  test("when list has only one author, equals the author", () => {
  ...
  test("when list has many authors, equals most prolific author", () => {
...
describe("most likes", () => {
  ...
  test("when list has many authors, equals most liked author", () => {
